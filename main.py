...
def scrapVideo(): 
    ...
    i = datetime.now()
    yesterday = i.day-1
    urlDomain = "https://www.youtube.com/channel/UCR_eeue4E0jNBz8A55DOuOg"                
    browser_c = Firefox()
...
def postFB():  
    ...
    user_token = 'EAACM9Se95aQBAA8kfBYZBAM9J6VlJXftQ5pyFFZAnU1kePGDlUn33SnBqE1BUVYjuuqKLeOZAC8mqZAMH4ZBS8XWsphwvNv3xEdanaP1W0ukpyAgtqVPibvYckNbNgv8xMAl8bXg4iXbobGcRHwoZC56az7sxqzVcZD'
    app_id = '154984561632676' # Obtained from https://developers.facebook.com/
    app_secret = 'a5dc49a7f2aa29a43d74efd8499e5e9a' # Obtained from https://developers.facebook.com/
    ...
    graphMe.put_wall_post(message=u'每日NBA快報-'+player+'-HighLight', attachment=attachment)
